...
def storeToADLS(topic, msg):
    ...
    storage_account_name = 'leahadls2'
    storage_account_key = 'N92raJBCpYNajWkEHi+4AIHkf6sdIxLyQ5ZFv5S086Bfif4/RIO01g6GMcHfU+SqcsnRlNnuclVFax7ECn6GZQ=='
    try:  
...
broker_props = {
    "solace.messaging.transport.host": os.environ.get('SOLACE_HOST') or "vmpp3r5gdtl2i3i0.centralus.cloudapp.azure.com",
